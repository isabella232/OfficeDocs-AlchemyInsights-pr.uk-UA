...
ms.locfileid: "30244386"
---
# <a name="set-up-email-in-the-outlook-mobile-app"></a>Настроювання електронної пошти в Outlook мобільний додаток

1. Виберіть **Почати роботу** , якщо це ваш перший раз Настроювання електронної пошти в мобільних приблизно в іншому, торкніться **меню** та виберіть пункт **настройки** \> **Додати обліковий запис** \> **Додати обліковий запис електронної пошти**. 
