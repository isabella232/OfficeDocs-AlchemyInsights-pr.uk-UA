...
ms.locfileid: "29500087"
---
# <a name="set-up-email-in-the-outlook-mobile-app"></a>Настроювання електронної пошти в Outlook мобільний додаток

1. Виберіть **Почати роботу** якщо це ваш перший час створення повідомлень у мобільних приблизно в іншому випадку натисніть **меню**![меню кнопки](media/265b9089-9630-42dd-a244-d9a412d8fe47.png) та торкніться кнопки **Параметри** \> **Додати обліковий запис** \> **Додати обліковий запис електронної пошти**. 
