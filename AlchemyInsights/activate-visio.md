...
Щоб активувати застосунок Visio:

1. Інсталюйте програму Visio з [порталу мій обліковий запис](https://portal.office.com/account#installs) , якщо його ще не інстальовано. Довідку див. в статті [Інсталяція Visio](https://support.office.com/article/f98f21e3-aa02-4827-9167-ddab5b025710?wt.mc_id=OfficeAdm_ClientDIA_Alchemy1800).
...
З питань активації запустіть [засіб усунення неполадок активації](https://aka.ms/SARA-OfficeActivation-Alchemy) на проблемному комп'ютері.
