...
Щоб отримати додаткові відомості про використання порталу InTune, див. [Додати користувачів і надати права адміністратора InTune](https://docs.microsoft.com/intune/fundamentals/users-add).