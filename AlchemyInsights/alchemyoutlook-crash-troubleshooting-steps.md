...
Якщо проблеми виникли після оновлення і вище кроки не працюють, може знадобитися повернутися до попередніх побудувати. Подивимося, [як повернутися до попередньої версії Office 2013 або натисніть 2016 Office-Office умить](https://support.microsoft.com/EN-US/help/2770432).
