...
Перегляньте статтю про те, [як зменшити кількість спаму в електронній пошті в Office 365](https://docs.microsoft.com/office365/securitycompliance/reduce-spam-email). 
