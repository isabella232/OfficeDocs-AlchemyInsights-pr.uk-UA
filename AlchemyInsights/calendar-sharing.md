...
ms.locfileid: "47684287"
---
# <a name="calendar-sharing-in-outlook"></a>Спільний доступ до календаря в програмі Outlook

Щоб отримати відомості про надання спільного доступу до календаря Outlook, ознайомтеся з наведеними нижче статтями.
