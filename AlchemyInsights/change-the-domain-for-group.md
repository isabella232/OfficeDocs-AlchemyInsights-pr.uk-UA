...
Після створення групи Microsoft 365 зараз немає способу змінити домен. Єдиний спосіб – створити нову групу Microsoft 365 і видалити стару, якщо потрібно (додаткові адреси електронної пошти можна додати через [Центр адміністрування Exchange](https://outlook.office365.com/ecp).