...
Якщо ви бажаєте негайно заблокувати доступ користувача та зберегти його інформацію, див. статті Блокування доступу колишнього працівника до [даних Microsoft 365.](https://docs.microsoft.com/microsoft-365/admin/add-users/remove-former-employee#block-a-former-employees-access-to-microsoft-365-data)
