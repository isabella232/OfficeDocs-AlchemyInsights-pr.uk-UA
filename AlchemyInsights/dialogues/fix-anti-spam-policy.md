...
ms.locfileid: "50696157"
---
# <a name="fix-anti-spam-policy"></a>Виправлення політики захисту від спаму
...
3. Розгорніть параметр **Властивості "спам** " і ознайомтеся з настройками функції " **помітити як спам** ".
