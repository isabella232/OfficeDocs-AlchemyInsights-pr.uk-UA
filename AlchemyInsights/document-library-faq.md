...
ms.locfileid: "51814943"
---
# <a name="document-library-faq"></a>Бібліотека документів: запитання й відповіді

**Усунення несправностей у бібліотеках документів:**

Перейдіть до [](https://docs.microsoft.com/sharepoint/troubleshoot/online) розділу "Списки та бібліотеки" та перейдіть до розділу "Списки та бібліотеки" та перейдіть до розділу "Списки та бібліотеки" вручну.
...
- [Передавання файлів до бібліотеки](https://support.office.com/article/upload-files-to-a-library-da549fb1-1fcb-4167-87d0-4693e93cb7a0)
