---
title: Керування версіями документів
ms.author: pebaum
author: pebaum
manager: scotv
ms.date: 07/22/2020
...
ms.locfileid: "45423982"
---
# <a name="document-versioning"></a>Керування версіями документів

Керування версіями ввімкнуто за промовчанням для документів і OneDrive, для бізнес-бібліотек. Щоб відновити версію файлів самостійно, зверніться до [відновлення попередньої версії файлу](https://support.office.com/article/restore-a-previous-version-of-a-file-in-onedrive-159cad6d-d76e-4981-88ef-de6e96c93893?ui=en-US&rs=en-US&ad=US).  

Докладніші відомості про керування версіями наведено в таких статтях:  

- Відомості про обмеження версій, див [SharePoint межі](https://docs.microsoft.com/office365/servicedescriptions/sharepoint-online-service-description/sharepoint-online-limits).     
...
- [Перегляд журналу версій елемента або файлу у списку або бібліотеці](https://support.office.com/article/View-the-version-history-of-an-item-or-file-in-a-list-or-library-53262060-5092-424D-A50B-C798B0EC32B1).
