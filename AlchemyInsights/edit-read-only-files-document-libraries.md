...
- Якщо ви віддаєте перевагу документів, відкрито для редагування у кабінеті, якщо клацнути назву, можна настроїти бібліотеку для цього (оскільки у вас є дозвіл змінювати параметри бібліотеки).
