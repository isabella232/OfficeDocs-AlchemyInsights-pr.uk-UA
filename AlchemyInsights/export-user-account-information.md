...
ms.locfileid: "51813385"
---
# <a name="export-user-account-information"></a>Експорт відомостей облікового запису користувача

Щоб експортувати відомості облікового запису користувача в Центрі адміністрування Microsoft 365, зокрема відомості про ліцензії, політику паролів, заблоковані облікові записи, стан синхронізації AAD тощо, перейдіть на сторінку Користувачі, активні користувачі, а потім  >  [](https://go.microsoft.com/fwlink/p/?linkid=834822) виберіть **Експортувати користувачів.**