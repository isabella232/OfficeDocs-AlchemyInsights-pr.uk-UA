...
Якщо багато файлів OneDrive або SharePoint видаляються, перезаписуються, пошкоджено або інфіковано зловмисними програмами, можна відновити всю бібліотеку OneDrive або SharePoint до попереднього моменту часу за допомогою функції відновлення файлів. Докладні відомості:
