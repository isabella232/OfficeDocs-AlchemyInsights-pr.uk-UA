...
Щоб інсталювати клієнтські програми Office, ви повинні мати підписку для бізнесу, як-от "Office 365 Business преміум", "Office 365 Business" або "Office 365 Education".
  
*ПРИМІТКА. [Office Для дому та бізнесу 2016](https://products.office.com/home-and-business) – це продукт [Office для дому](https://support.office.com/article/28cbc8cf-1332-4f04-9123-9b660abb629e?wt.mc_id=Alchemy_ClientDIA), який не входить у передплату для бізнесу. Перегляньте статті про [інсталяцію Visio](https://support.office.com/article/f98f21e3-aa02-4827-9167-ddab5b025710) та [Project](https://support.office.com/article/7059249b-d9fe-4d61-ab96-5c5bf435f281), щоб отримати конкретні інструкції.*

Створіть облікові записи користувачів і додайте свій домен. Переконайтеся, що користувач має [призначену ліцензію](https://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc?wt.mc_id=Alchemy_ClientDIA).
...
3. У розділі Office вибрати потрібну мову. Натисніть **Додатково**, щоб вибрати 32- або 64-розрядну версію. 
4. Натисніть кнопку **Інсталювати**.
