...
ms.locfileid: "30758127"
---
# <a name="install-skype-for-business"></a><span data-ttu-id="95dde-102">Установки Skype для бізнесу</span><span class="sxs-lookup"><span data-stu-id="95dde-102">Install Skype for Business</span></span>

<span data-ttu-id="95dde-103">Ви можете встановити Skype для бізнесу, виконавши дії, описані в цій статті: [Встановити Skype для бізнесу](https://support.office.com/article/Install-Skype-for-Business-8a0d4da8-9d58-44f9-9759-5c8f340cb3fb.aspx)</span><span class="sxs-lookup"><span data-stu-id="95dde-103">You can install Skype for Business by following the steps in this article: [Install Skype for Business](https://support.office.com/article/Install-Skype-for-Business-8a0d4da8-9d58-44f9-9759-5c8f340cb3fb.aspx)</span></span>
