...
ms.locfileid: "37590578"
---
# <a name="microsoft-teams---guest-access"></a>Microsoft teams – гостьовий доступ

Якщо вам потрібна допомога в спілкуванні з користувачами поза межами вашої організації у teams, потрібно вирішити, чи використовувати [гостьовий доступ або зовнішній доступ (Федерацію)](https://docs.microsoft.com/en-us/microsoftteams/manage-external-access#external-access-vs-guest-access), або увімкнути їх обох.

Існують деякі важливі відмінності між цими функціями. Ви можете віддати перевагу гостьовій доступ через ширший набір функцій. Однак, зовнішній доступ (Федерація) відмінно підходить для простіших комунікацій з зовнішніми користувачами. [Не забудьте переглянути відмінності](https://docs.microsoft.com/en-us/microsoftteams/manage-external-access#external-access-vs-guest-access) і вибрати один найкраще підходить для ваших потреб бізнесу.

Якщо ви хочете увімкнути доступ гостя, переконайтеся, що ви виконали всі дії, зазначені в [переліку запрошених доступу](https://docs.microsoft.com/en-us/microsoftteams/guest-access-checklist). Після того, як ви повністю закінчите, вам потрібно буде [зачекати до 24 годин](https://docs.microsoft.com/en-us/microsoftteams/manage-guests#guest-access-latencies) , щоб налаштування набрали сили.
