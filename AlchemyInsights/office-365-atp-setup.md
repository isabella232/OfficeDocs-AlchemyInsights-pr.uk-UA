...
---
# <a name="microsoft-defender-for-office-365-atp"></a>Програма Microsoft Defender для Office 365 (АТФ)
...
Для захисту АТФ, який має бути в силі, потрібно настроїти політики. [Короткий посібник із початку роботи: настроювання програми Microsoft Defender для Office 365](https://docs.microsoft.com/office365/securitycompliance/checklist-atp-setup).
