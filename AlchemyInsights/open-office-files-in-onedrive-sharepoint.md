...
Якщо виникають проблеми з відкриттям файлів Office і документів із бібліотек документів SharePoint або OneDrive, ось кілька порад, які допоможуть виправити їх.
...
- [Завантаження та перевірка пошкодження файлу на локальному комп'ютері](https://support.office.com/article/How-to-recover-missing-deleted-or-corrupted-items-in-SharePoint-Online-and-OneDrive-for-Business-3d748edf-c072-46c9-81a4-4989056ebc87[])
...
Щоб отримати додаткові відомості або деталі, будь ласка, перевірте стаття [виправити неполадки відкриття документів у бібліотеках SharePoint](https://support.office.com/article/Fix-problems-opening-documents-in-SharePoint-libraries-31329FA1-4AD0-47FC-95D8-BB0C5B12A536)
