...
**Налаштування** > **Переглянути всі настройки Outlook** > **пошти** > **автоматичні відповіді** , щоб відкрити [Параметри автовідповіді](https://outlook.live.com/mail/options/mail/automaticReplies).
