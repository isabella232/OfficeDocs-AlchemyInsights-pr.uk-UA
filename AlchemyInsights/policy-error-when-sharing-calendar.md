...
ms.locfileid: "47728380"
---
# <a name="policy-error-when-sharing-a-calendar"></a>Помилка політики під час надання спільного доступу до календаря

Якщо ви намагаєтеся надати спільний доступ до календаря, з'являється повідомлення про помилку "політика не дає дозволу на надання дозволів на цей рівень для одного або кількох одержувачів", перегляньте [цю тему](https://support.microsoft.com/help/3187524/policy-does-not-allow-granting-permissions-at-this-level-to-one-or-mor).
