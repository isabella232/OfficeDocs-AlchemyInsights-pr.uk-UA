...
Вибрати, як Outlook.com реагує на читати запитів сповіщення, перейдіть до [Параметри обробка повідомлень](https://go.microsoft.com/fwlink/?linkid=2080838) (**Параметри** > **Переглянути всі настройки Outlook** > **обробка повідомлень**).