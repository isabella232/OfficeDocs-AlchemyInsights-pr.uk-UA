...
Користувач може змінити власний пароль у меню **Безпека облікового**  >  [запису & конфіденційності.](https://portal.office.com/account/#security)
...
[Клацніть тут, щоб дізнатися більше](https://docs.microsoft.com/microsoft-365/admin/add-users/reset-passwords), або дозвольте користувачам скидати власні забуті паролі.
