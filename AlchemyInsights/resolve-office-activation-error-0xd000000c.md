...
ms.locfileid: "43116621"
---
# <a name="resolve-office-activation-error-0xd000000c"></a>Виправлення помилки активації Office 0xD000000C

- Перевірте наявність підключення до Інтернету на комп’ютері Mac, на якому ви намагаєтесь інсталювати Office. Це можна зробити, відкривши браузер і перейшовши на сайт www.microsoft.com. Якщо сторінка завантажується, підключення до Інтернету встановлено.
