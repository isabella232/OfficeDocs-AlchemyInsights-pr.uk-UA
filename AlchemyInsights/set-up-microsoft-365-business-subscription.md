...
ms.locfileid: "43764498"
---
# <a name="set-up-a-microsoft-365-business-subscription"></a>Налаштування передплати на Microsoft 365 Business

Перегляньте докладні інструкції з налаштування передплати для бізнесу в розділі [Налаштування Office 365 для бізнесу](https://docs.microsoft.com/microsoft-365/admin/setup/setup?view=o365-worldwide). 
