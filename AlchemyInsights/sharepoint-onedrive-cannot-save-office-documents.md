...
---
# <a name="cannot-save-office-documents-to-sharepoint-or-onedrive-document-library"></a>Не вдалося зберегти документи Office у бібліотеці документів SharePoint або OneDrive
...
Для отримання додаткової інформації або деталі, будь ласка, посилання статті [виправити проблеми відкриття або збереження документів у бібліотеках SharePoint](https://support.office.com/article/Fix-problems-opening-documents-in-SharePoint-libraries-31329FA1-4AD0-47FC-95D8-BB0C5B12A536)
