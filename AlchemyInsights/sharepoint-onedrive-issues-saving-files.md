...
ms.locfileid: "53910533"
---
# <a name="cannot-save-office-documents-to-sharepoint-or-onedrive-document-libraries"></a>Не вдається Office документів у SharePoint OneDrive бібліотеках документів

Якщо виникають проблеми зі збереженням Office в SharePoint або OneDrive бібліотек документів, ось деякі відомості, які можуть допомогти.
...
Докладні відомості або докладні відомості див. в статті Вирішення проблем із відкриттям або збереженням документів [у SharePoint бібліотеках](https://support.office.com/article/Fix-problems-opening-documents-in-SharePoint-libraries-31329FA1-4AD0-47FC-95D8-BB0C5B12A536)
