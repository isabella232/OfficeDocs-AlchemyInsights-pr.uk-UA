...
Ця помилка може відображатися, якщо антивірусне програмне забезпечення, брандмауер, настройки проксі-сервера або підключення перешкоджають інсталяції Office. Ось деякі речі, які можна спробувати вирішити цю проблему.
  
- Використання проводового підключення

- Тимчасове вимкнення настройок проксі-сервера
