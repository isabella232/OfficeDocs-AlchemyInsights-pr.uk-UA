---
title: Перевірка вбудованих зображень Алхімія
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="354b6-102">Доступ до сторінки "домени"</span><span class="sxs-lookup"><span data-stu-id="354b6-102">Access the Domains Page</span></span>

<span data-ttu-id="354b6-103">Щоб отримати доступ до сторінки "домени", просто клацніть цю піктограму нижче.</span><span class="sxs-lookup"><span data-stu-id="354b6-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="354b6-104">Потім можна додати, змінити або видалити свій домен.</span><span class="sxs-lookup"><span data-stu-id="354b6-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="354b6-105">Докладні відомості наведено в розділі [запитання й відповіді про домени.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="354b6-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
