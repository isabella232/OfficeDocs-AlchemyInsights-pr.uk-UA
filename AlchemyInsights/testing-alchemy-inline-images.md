...
ms.locfileid: "36507184"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="38bc4-102">Отримати доступ до сторінки домени</span><span class="sxs-lookup"><span data-stu-id="38bc4-102">Access the Domains Page</span></span>

<span data-ttu-id="38bc4-103">Отримати доступ до сторінки домени, просто натисніть цю піктограму нижче:</span><span class="sxs-lookup"><span data-stu-id="38bc4-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="38bc4-104">Потім можна додати, змінити або видалити ваш домен.</span><span class="sxs-lookup"><span data-stu-id="38bc4-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="38bc4-105">Докладніше, перегляньте статтю на [доменах FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="38bc4-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
