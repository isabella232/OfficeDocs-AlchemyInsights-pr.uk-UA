...
---
# <a name="access-the-domains-page"></a>Доступ до сторінки "домени"

Щоб отримати доступ до сторінки "домени", просто клацніть цю піктограму нижче.
...
Потім можна додати, змінити або видалити свій домен.
Докладні відомості наведено в розділі [запитання й відповіді про домени.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)
