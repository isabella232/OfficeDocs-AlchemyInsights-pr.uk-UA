...
ms.locfileid: "29495714"
---
# <a name="set-up-domain-and-users"></a>Настроювання домену та користувачів

Коли ви будете готові до настроювання домену та користувачів, дивитися це швидкий відео:
  
![Ваш браузер не підтримує відео. Установки Microsoft Silverlight, Adobe Flash Player або Internet Explorer 9.](media/MSN_Video_Widget.gif)
