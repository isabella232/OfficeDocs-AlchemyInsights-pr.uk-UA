...
ms.locfileid: "28319784"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Усунення несправностей із Apple MDM підштовхнути сертифікат Microsoft Intune

Огляд ресурсів, перераховані нижче, щоб вирішити проблему, ваш тепер. 
  
1. Огляд [цей документ](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) , щоб настроїти або оновити сертифікат push Apple MDM. 
