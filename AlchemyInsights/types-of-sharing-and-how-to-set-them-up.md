...
ms.locfileid: "47800089"
---
# <a name="different-types-of-shared-outlook-calendars-and-how-to-set-them-up"></a>Різні типи спільних календарів Outlook та як їх налаштувати

- [Створення спільної поштової скриньки](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox)

- [Поштові скриньки приміщень і обладнання](https://docs.microsoft.com/microsoft-365/admin/manage/room-and-equipment-mailboxes)
