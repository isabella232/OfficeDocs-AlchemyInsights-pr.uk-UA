...
---
# <a name="verify-your-domain-with-bluehost"></a>Підтвердження домену за допомогою Bluehost
...
Перегляньте [записи про створення записів DNS на Bluehost для Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-bluehost) для покрокових інструкцій.