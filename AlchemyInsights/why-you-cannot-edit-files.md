...
ms.locfileid: "43209441"
---
# <a name="why-cant-i-edit-files"></a>Чому не можна редагувати файли?

Погляньте на деякі з причин, [чому ви, можливо, не зможете відредагувати файл](https://support.office.com/article/why-can-t-i-edit-this-file-97315f48-aa5e-49d3-a4ae-a14b73daf87b).

Якщо у вас є бібліотеки з **перевірки, обов'язкові** або **перевірки** стовпців або метаданих, або коли **проект елемента безпеки** встановлено **лише користувачі, які можуть редагувати** або **лише користувачі, які можуть затвердити елементи** в настройках версії бібліотеки:
...
- [Я отримав "не вдалося завантажити" або "не вдалося зберегти автоматично" помилка під час редагування файлу Office](https://support.office.com/article/i-got-an-upload-failed-or-couldn-t-save-automatically-error-while-editing-an-office-file-93a14d34-88e3-4a91-9eef-58cc541d31f8)
