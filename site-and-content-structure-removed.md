...
Скористайтеся перемістити файл і копію вмісту сайту і структури. Докладніше перегляньте [копіювати файли та папки між OneDrive та сайтом SharePoint](https://support.office.com/en-us/article/copy-files-and-folders-between-onedrive-and-sharepoint-sites-67a6323e-7fd4-4254-99a8-35613492a82f). 

Для отримання додаткової інформації будь ласка, зверніться до [роботи з сайту змісту та структури](https://support.office.com/en-us/article/Work-with-site-content-and-structure-30fcaad9-02b1-4347-8b03-e1ccc5a4c19f).
